...
import cn.sliverwork.framework.controller.*;
import cn.sliverwork.application.service.impl.*;
import org.springframework.beans.factory.annotation.*;
import cn.sliverwork.application.service.*;
import org.slf4j.*;
import cn.sliverwork.framework.util.yml.*;
import javax.servlet.http.*;
import cn.sliverwork.framework.util.user.*;
import org.apache.shiro.*;
import org.apache.shiro.authc.*;
import cn.sliverwork.framework.exception.*;
import org.apache.shiro.subject.*;
import org.apache.shiro.session.*;
import org.apache.shiro.session.mgt.eis.*;
import cn.sliverwork.framework.util.uuid.*;
...
public class LoginController extends BaseController
{
    ...
    public LoginController() {
        ...
        this.PATH = cn.sliverwork.framework.util.yml.a.get("sliverwork.conf");
        this.l = 100000001L;
        this.m = 100000000L;
    }
    ...
    public Map<String, Object> a(final SystemUser user, final HttpServletRequest request) {
        final Map<String, String> info = cn.sliverwork.framework.util.user.b.getLicenceInfo();
        if (!cn.sliverwork.framework.util.user.b.e(info)) {
            this.a.a((Map)info);
            return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.M();
        }
        final String userName = user.getUserName();
        if (null == userName) {
            return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.c("login.userNameNotBlank", new Object[0]);
        }
        ...
        try {
            ...
            return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.c("login.unknownAccount", new Object[0]);
        }
        catch (IncorrectCredentialsException ice) {
            return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.c("login.passwordIncorrect", new Object[0]);
        }
        catch (LockedAccountException lae) {
            return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.c("login.accountLocked", new Object[0]);
        }
        catch (ExcessiveAttemptsException eae) {
            return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.c("login.accountLockedTimes", new Object[0]);
        }
        catch (DisabledAccountException sae) {
            return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.c("login.accountDisabled", new Object[0]);
        }
        catch (AuthenticationException ae) {
            return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.c("login.accountAndPassIncorrect", new Object[0]);
        }
        final Date current = new Date();
        if (!currentUser.isAuthenticated()) {
            token.clear();
            return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.c("login.failure", new Object[0]);
        }
        final Session session = currentUser.getSession();
        final SystemUser tUser = this.service.w(userName);
        if (cn.sliverwork.framework.util.user.b.h(info) && !tUser.getUserId().equals(this.l)) {
            return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.c("login.personalLoginError", new Object[0]);
        }
        try {
            this.d.reset();
        ...
        return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.b("login.success", new Object[] { result });
    }
    ...
    public Map<String, Object> a(final HttpServletRequest request) {
        ...
        return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.a(new Object[0]);
    }
    ...
    private boolean a(final String username, final String sessionID) {
        ...
        final EnterpriseCacheSessionDAO sessionDAO = (EnterpriseCacheSessionDAO)cn.sliverwork.framework.util.context.a.R("sessionDao");
    ...
    private void a(final HttpServletRequest request, final Long userId, final Date current, final String type) {
        ...
        final String ip = cn.sliverwork.framework.util.ip.a.b(request);
        if (null != ip) {
            this.c.setLogIp(ip);
            final String local = cn.sliverwork.framework.util.ip.a.T(ip);
    ...
    public Map<String, Object> a() {
        return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.b("SUCCESS", new Object[] { cn.sliverwork.framework.util.user.b.getLicenceInfo() });
    }
    ...
    public Map<String, Object> a(@RequestParam(name = "file", required = true) final MultipartFile file) {
        ...
        try {
            if (file.getSize() > 5120L) {
                return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.c("error.licenceFileOverSize", new Object[0]);
            }
            if (!file.getOriginalFilename().equals("sliver.licence")) {
                return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.c("error.licenceName", new Object[0]);
            }
            in = file.getInputStream();
            final FileOutputStream out = new FileOutputStream(this.PATH + File.separator + "sliver.licence");
            final int len = in.available();
            final byte[] buffer = new byte[len];
            in.read(buffer);
            out.write(buffer);
            out.close();
            result = cn.sliverwork.framework.util.user.b.getLicenceInfo();
            final Map<String, String> info = cn.sliverwork.framework.util.user.b.R();
            if (null == info) {
                return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.a(new Object[] { result });
            }
            this.a.a((Map)info);
            final String code = result.get("code");
            if (null == code || "".equals(code)) {
                result.put("code", cn.sliverwork.framework.util.user.b.getMachineCode());
            }
            return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.c("Failure", new Object[] { result });
        }
        catch (Exception e) {
            e.printStackTrace();
            this.log.error(e.getMessage());
            return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.c("error.internalError", new Object[0]);
        }
        finally {
            if (null != in) {
                try {
    ...
    public Map<String, Object> b() {
        ...
        return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.b();
    }

    @RequestMapping({ "/login" })
    public Map<String, Object> c() {
        return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.c("NOTLOGIN", new Object[0]);
    }
    ...
    public Map<String, Object> d() {
        ...
        if (null != userId) {
            ...
            list = cn.sliverwork.framework.util.user.b.b(list);
            if (null != list && list.size() > 0) {
                for (int z = 0; z < list.size(); ++z) {
                    this.a(list.get(z));
                }
            }
            return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.a(new Object[] { list });
        }
        return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.b(new Object[0]);
    }
            ...
            try {
                if (null != user.getUserPass() && !"".equals(user.getUserPass()) && null != user.getRepassword() && !"".equals(user.getRepassword()) && user.getUserPass().equals(user.getRepassword())) {
                    if (!user.getUserPass().equals(user.getRepassword())) {
                        return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.c("profile.passNotEqual", new Object[0]);
                    }
                    ...
                    if (null != temp) {
                        ...
                        if (!old_pass.equals(temp.getUserPass())) {
                            return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.c("profile.passNotCorrect", new Object[0]);
                        }
                ...
                e.printStackTrace();
                return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.J();
            }
        }
        return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.c("profile.updateError", new Object[0]);
    }
    ...
    public Map<String, Object> c(final SystemUser user) {
        ...
        return (Map<String, Object>)cn.sliverwork.framework.util.controller.b.a(new Object[] { num });
    }
